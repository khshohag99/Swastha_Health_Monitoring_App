...
class DummyDash extends StatefulWidget {
  const DummyDash({Key? key}) : super(key: key);
...
class _DummyDashState extends State<DummyDash> {
  ...
  readDataFromLocal() async {
    ...
    //fetching data for Height Duration
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: kThemeValue
          ? const Color(0xFF0A0D22)
          : Colors.white, //const Color(0xFF0A0D22), //Color(0xff181C1F),
      appBar: AppBar(
        ...
        backgroundColor: kThemeValue
            ? const Color(0xFF0A0D22)
            : Colors.white, //Color(0xFF0A0D22), //const Color(0xff181C1F),
        title: const Text(
          "Swastha",
          style: TextStyle(
