...
Future insertData(List results, String uuid) async {
  ...
  if (uuid != "") {
    ...
    final DocumentReference ref =
        FirebaseFirestore.instance.collection("data").doc(uuid);
    ...
    results.forEach((final datapoint) {
      ...
      final HashMap<String, dynamic> x =
          HashMap<String, dynamic>.from(datapoint);
